...
| E37 | **Closure ist quellen-partitioniert**: Offene Versionen führen eine Provenienz-Menge (liefernde/bestätigende Quellen); Lösch-Kandidat ist eine Scope-Identität nur, wenn `meta.source` in ihrer Provenienz-Menge liegt — quellenübergreifendes Schliessen nur mit explizitem `scope.authoritativeForSources` (FR-5.2, FR-5.5a, FR-5.6) | 2026-07 |
