...
22. **Multi-Source-Merge (E40/E44):** (a) Ein Snapshot der Quelle B ohne die von Quelle A gelieferte Property entfernt diese nicht; (b) liefert B einen abweichenden Wert, entsteht ein ausgewiesener Konflikt, aufgelöst gemäss `SOURCE_PRECEDENCE` bzw. nach Snapshot-Instant; (c) ein **älterer** B-Snapshot, der nach einem jüngeren A-Snapshot importiert wird, überschreibt dessen Property-Wert nicht; (d) dieselben Regeln gelten für ein abweichendes `label`; (e) bei **gleichem** Instant ohne Präzedenz entscheidet der deterministische Quellen-Tie-Breaker — dasselbe Ergebnis unabhängig von der Importreihenfolge.
