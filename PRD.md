...
| E40 | **Multi-Source-Merge auf Property-Ebene**: Jede Property gehört der Quelle, die sie zuletzt geliefert hat; nur die liefernde Quelle kann sie entfernen; Wert-Konflikte zwischen Quellen folgen der optionalen Tenant-Präzedenz (`SOURCE_PRECEDENCE`), sonst last-write-wins mit **ausgewiesenem** Konflikt — nie still (FR-5.6) | 2026-07 |
...
22. **Multi-Source-Merge (E40):** Ein Snapshot der Quelle B ohne die von Quelle A gelieferte Property entfernt diese nicht; liefert B einen abweichenden Wert, entsteht ein ausgewiesener Konflikt, der gemäss `SOURCE_PRECEDENCE` bzw. last-write-wins aufgelöst wird — nie still.
