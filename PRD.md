...
3. Ein AdminDir-Crawl über die volle Pipeline (Phase A → Gate → Phase A.5 → Phase B, FR-6.1) liefert einen validen Snapshot mit `meta.scope`, der ohne Handarbeit importierbar ist; der Phase-A-Lauf kommt dabei ohne LLM aus (E27).
